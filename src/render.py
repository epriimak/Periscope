...
class Renderer:
    ...
    def render(self, p1_intersect, p2_intersect, target: Target, prev_target: Target, p_aim):
        ...
        self.__render_geometry(p1_intersect, p2_intersect,  target, prev_target, p_aim)
        pygame.display.flip()


    def __render_geometry(self, p1_intersect, p2_intersect,  target: Target, prev_target: Target, p_aim):
        ...
        draw_sphere(prev_target.location.get_point(), prev_target.radius, color_s=BLUE_PREV)
